...
func NewFiefAPI(spec *loads.Document) *FiefAPI {
	return &FiefAPI{
		...
		GamePostGamesIDInstructionsHandler: game.PostGamesIDInstructionsHandlerFunc(func(params game.PostGamesIDInstructionsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation game.PostGamesIDInstructions has not yet been implemented")
		}),
		ManagePostGamesIDJoinHandler: manage.PostGamesIDJoinHandlerFunc(func(params manage.PostGamesIDJoinParams, principal interface{}) middleware.Responder {
...
type FiefAPI struct {
	...
	GamePostGamesIDInstructionsHandler game.PostGamesIDInstructionsHandler
	// ManagePostGamesIDJoinHandler sets the operation handler for the post games ID join operation
...
func (o *FiefAPI) Validate() error {
	...
	if o.GamePostGamesIDInstructionsHandler == nil {
		unregistered = append(unregistered, "game.PostGamesIDInstructionsHandler")
	}
	if o.ManagePostGamesIDJoinHandler == nil {
		unregistered = append(unregistered, "manage.PostGamesIDJoinHandler")
	}
...
func (o *FiefAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/games/{id}/instructions"] = game.NewPostGamesIDInstructions(o.context, o.GamePostGamesIDInstructionsHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/games/{id}/join"] = manage.NewPostGamesIDJoin(o.context, o.ManagePostGamesIDJoinHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/games/new"] = manage.NewPostGamesNew(o.context, o.ManagePostGamesNewHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
